...
int main(int argc, char* argv[]) {
		...
		// Configure program icon - light-green background, black foreground
		log_settings.set_program_icon("=WALLET=");
		log_settings.set_program_icon_usecolor(true);
		log_settings.set_program_icon_fg(static_cast<int>(ecul::Color::Black));
		log_settings.set_program_icon_bg(static_cast<int>(ecul::Color::LightGreen));
